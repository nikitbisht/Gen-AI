...
class Review(TypedDict):
    key_themes : Annotated[list[str],'write down all the key themes discurss in the review in a list']
    ...
    pros: Annotated[Optional[list[str]],'write down all the prons inside the list']
